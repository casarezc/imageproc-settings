...
#define IDENT_STR "CASAREZC-ROACH;SRTAIL;"
...
//Tail zero sensor input port
#define TAIL_ZERO_INPUT   _RB3

//Tail zero values
#define TAIL_ZERO_POS 4088
#define TAIL_ZERO_NEG -6501
